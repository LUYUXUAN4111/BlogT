...
<body>
    ...
    <div style="display:grid ;grid-template-columns: 300px auto;position: relative;left: 10%">
        <div>
            <div class="card" style="width: 300px;padding: 10px;position: sticky;top: 70px;left: 20px;max-height: 500px;margin-top: 20px">
        ...
        <div style="max-width: 1000px;width: 80%;padding: 30px;margin: 20px;word-break: break-word">
